...
public class CircleScreenshot {
    ...
    public static final class Builder {
        ...
        public void buildWithNodes(ViewNodeProvider viewNodeProvider, Callback<CircleScreenshot> callback) {
            List<DecorView> decorViews = WindowHelper.get().getTopActivityViews();
            build(decorViews, viewNodeProvider, callback);
        }

        public void build(Callback<CircleScreenshot> callback) {
        }

        void build(List<DecorView> decorViews, ViewNodeProvider viewNodeProvider, Callback<CircleScreenshot> callback) {
            if (callback == null || viewNodeProvider == null) {
                return;
            }
            ...
            try {
                ...
                JSONArray v = viewNodeProvider.buildScreenViews(decorViews);
