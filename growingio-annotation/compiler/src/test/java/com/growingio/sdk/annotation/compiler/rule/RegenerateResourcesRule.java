...
import com.growingio.sdk.annotation.compiler.TestUtil;
...
import static com.growingio.sdk.annotation.compiler.TestUtil.asUnixChars;


/**
 * Regenerates test resources for annotation compiler tests when
 * property is set to the directory containing the project.
 *
...
public final class RegenerateResourcesRule implements TestRule {
    ...
    return new Statement() {
      ...
      public void evaluate() throws Throwable {
        try {
          ...
          String projectRoot = TestUtil.getProjectRootIfRegeneratingTestResources();
  ...
  private void updateResourceFile(
      AssertionError e, String projectDirectory, Description description) {
