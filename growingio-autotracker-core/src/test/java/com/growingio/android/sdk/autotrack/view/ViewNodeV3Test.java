...
public class ViewNodeV3Test {
    ...
    public void viewNodeTest() {
        ...
        Truth.assertThat(viewNode.getXPath()).endsWith("/Page/DecorView/LinearLayout[0]/FrameLayout[0]/FitWindowsLinearLayout[0]#action_bar_root/ContentFrameLayout[0]/LinearLayout[0]/TextView[0]");
        ...
        Truth.assertThat(newNode.getXPath()).endsWith("/Page/DecorView/LinearLayout[0]/FrameLayout[0]/FitWindowsLinearLayout[0]#action_bar_root/ContentFrameLayout[0]/LinearLayout[0]/TextView[0]/ImageView[0]");
        ...
        Truth.assertThat(listItemNode.getXPath()).endsWith("/Page/DecorView/LinearLayout[0]/FrameLayout[0]/FitWindowsLinearLayout[0]#action_bar_root/ContentFrameLayout[0]/LinearLayout[0]/RecyclerView[0]/TextView[-]");
    }
