...
public class MenuItemInjector {
    ...
    public static void toolbarOnMenuItemClick(Toolbar.OnMenuItemClickListener listener, MenuItem item) {
        InjectorProvider.get().toolbarMenuItemOnClick(item);
    }
/*
