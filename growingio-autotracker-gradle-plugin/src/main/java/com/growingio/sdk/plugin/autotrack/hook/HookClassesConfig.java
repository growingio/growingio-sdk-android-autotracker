...
public class HookClassesConfig {
  ...
  static {
    ...
    putSuperHookMethod("android/view/MenuItem$OnMenuItemClickListener", "onMenuItemClick", "(Landroid/view/MenuItem;)Z", "com/growingio/android/sdk/autotrack/click/ViewClickInjector", "menuItemOnMenuItemClick", "(Landroid/view/MenuItem$OnMenuItemClickListener;Landroid/view/MenuItem;)V", false);
