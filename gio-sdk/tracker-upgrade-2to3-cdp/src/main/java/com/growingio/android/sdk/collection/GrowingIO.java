...
public class GrowingIO implements IGrowingIO {
    ...
    /**
     * @deprecated {@link GrowingTracker#get()}
     */
    @Deprecated
    ...
    public IGrowingIO setUserAttributes(Map<String, ?> attributes) {
        ...
        GrowingTracker.get().setLoginUserAttributes(stringHashMap);
        return this;
    }

    @Override
    public IGrowingIO setUserAttributes(JSONObject jsonObject) {
        GrowingTracker.get().setLoginUserAttributes(JsonUtil.copyToMap(jsonObject));
        return this;
    }
    ...
    public IGrowingIO track(String eventName, JSONObject var) {
        GrowingTracker.get().trackCustomEvent(eventName, JsonUtil.copyToMap(var));
        return this;
    }

    @Override
    public IGrowingIO track(String eventName, JSONObject var, String itemId, String itemKey) {
        GrowingTracker.get().trackCustomEvent(eventName, JsonUtil.copyToMap(var), itemKey, itemId);
        return this;
    }
    ...
    public IGrowingIO bridgeForWebView(Object webView) {
        if (webView instanceof View) {
            GrowingTracker.get().bridgeWebView((View) webView);
        }
        return this;
    }
    ...
    public IGrowingIO bridgeForX5WebView(Object x5WebView) {
        if (x5WebView instanceof View) {
            GrowingTracker.get().bridgeWebView((View) x5WebView);
        }
        return this;
    }
