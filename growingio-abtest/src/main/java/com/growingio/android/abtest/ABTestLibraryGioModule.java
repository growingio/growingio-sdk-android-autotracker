 ...
 */
@GIOLibraryModule(config = ABTestConfig.class)
public class ABTestLibraryGioModule extends LibraryGioModule {
    @Override
    public void registerComponents(TrackerContext context) {
        context.getRegistry().register(ABTest.class, ABExperiment.class, new ABTestDataLoader.Factory(context));
    }
}
