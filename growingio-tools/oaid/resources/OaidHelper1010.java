...
public class OaidHelper1010 implements IOaidHelper {
    private static final String TAG = "OaidHelper1010";
        ...
        public void OnSupport(boolean isSupport, IdSupplier idSupplier) {
            try {
                if (isSupport && idSupplier != null) {
                    OaidHelper1010.this.mOaid = idSupplier.getOAID();
                    Logger.d(TAG, "getOAID: " + OaidHelper1010.this.mOaid);
                } else {
            ...
            synchronized (OaidHelper1010.this) {
                OaidHelper1010.this.mPreloading = true;
                OaidHelper1010.this.notifyAll();
            }
        }
    }
