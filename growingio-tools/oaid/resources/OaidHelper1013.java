...
public class OaidHelper1013 implements IOaidHelper {
    private static final String TAG = "OaidHelper1013";
        ...
        public void OnSupport(boolean isSupport, IdSupplier idSupplier) {
            try {
                if (isSupport && idSupplier != null) {
                    OaidHelper1013.this.mOaid = idSupplier.getOAID();
                    Logger.d(TAG, "getOAID: " + OaidHelper1013.this.mOaid);
                } else {
            ...
            synchronized (OaidHelper1013.this) {
                OaidHelper1013.this.mPreloading = true;
                OaidHelper1013.this.notifyAll();
            }
        }
    }
