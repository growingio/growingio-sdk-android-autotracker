...
package com.growingio.sdk.inject.compiler;import com.google.testing.compile.JavaFileObjects;
...
public final class TestUtil {
    ...
    private static final String GROWINGIO_PACKAGE_NAME = "com.growingio.android.sdk";
     ...
     */
    public static String getProjectRootIfRegeneratingTestResources() {
    ...
    public static JavaFileObject forResource(String directoryName, String name) {
        try {
            ...
            return JavaFileObjects.forSourceString("com.growingio.sdk.annotation.compiler", name);
        }
    }
