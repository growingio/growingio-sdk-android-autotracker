...
&& ./gradlew :growingio-adapter:analytics:publishMavenAgentPublicationToMavenLocal \
&& ./gradlew :growingio-adapter:analytics3:publishMavenAgentPublicationToMavenLocal \
